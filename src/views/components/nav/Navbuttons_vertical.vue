      ...
      >
        ...
        <div class="lg:hidden">
          <div class="px-2 pt-2 pb-3 sm:px-3">
            ...
            :key="row.title"
            :href="row.url" 
            class="block no-underline px-3 py-2 my-2 rounded-md text-base font-medium text-neutral-900 bg-neutral-200 hover:bg-gray-500 focus:outline-none focus:text-white focus:bg-gray-700 transition duration-150 ease-in-out">
            {{row.title}}
          </a>
           </div>
        </div>
